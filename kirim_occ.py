...
def nama_file_ss():
    return os.path.join(FOLDER_GAMBAR, f"Report_OCC_{tanggal_hari_ini()}.png")


def nama_file_log():
    return os.path.join(FOLDER_LOG, "occ_log.txt")
...
def kirim_via_whatsapp(path_gambar):
    ...
    try:
        ...
        payload = {
            ...
            "file": {
                "mimetype": "image/png",
                "filename": f"Report_OCC_{tanggal_hari_ini()}.png",
                "data": encoded_string
            },
            "caption": f"📊 *Reporting OCC Uplink GPON*\n📝Created by ISP.SBT\nTanggal: {tanggal_hari_ini()}"
        }
...
def tugas_harian():
    ...
    catat_log("=" * 50)
    catat_log("🚀 Memulai tugas harian OCC...")
    ...
    catat_log("🏁 Tugas harian OCC selesai.")
    catat_log("=" * 50)


if __name__ == "__main__":
    print("=" * 55)
    print("  📱 Auto Screenshot & Kirim WA (OCC)")
