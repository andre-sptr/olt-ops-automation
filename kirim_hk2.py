...
def nama_file_ss():
    return os.path.join(FOLDER_GAMBAR, f"Report_HK2_{tanggal_hari_ini()}.png")


def nama_file_log():
    return os.path.join(FOLDER_LOG, "hk2_log.txt")
...
def kirim_via_whatsapp(path_gambar):
    ...
    try:
        ...
        payload = {
            ...
            "file": {
                "mimetype": "image/png",
                "filename": f"Report_HK2_{tanggal_hari_ini()}.png",
                "data": encoded_string
            },
            "caption": f"📊 *Reporting Realisasi PT2 SUMBAGTENG sd HI*\nTanggal: {tanggal_hari_ini()}"
        }
...
def tugas_harian():
    """Tugas harian: screenshot -> crop -> optimasi -> kirim WA -> hapus gambar."""
    catat_log("=" * 50)
    catat_log("🚀 Memulai tugas harian HK2...")
    ...
    catat_log("🏁 Tugas harian HK2 selesai.")
    catat_log("=" * 50)


if __name__ == "__main__":
    print("=" * 55)
    print("  📱 Auto Screenshot & Kirim WA (HK2)")
