...
def nama_file_ss():
    return os.path.join(FOLDER_GAMBAR, f"Reporting_HEM-DUM_{tanggal_hari_ini()}.png")


def nama_file_log():
    return os.path.join(FOLDER_LOG, "hem-dum_log.txt")
...
def kirim_via_whatsapp(path_gambar):
    ...
    try:
        ...
        payload = {
            ...
            "file": {
                "mimetype": "image/png",
                "filename": f"Reporting_HEM-DUM_{tanggal_hari_ini()}.png",
                "data": encoded_string
            },
...
def tugas_harian():
    """Alur utama program."""
    catat_log("=" * 50)
    catat_log("🚀 Memulai tugas harian HEM-DUM...")
    ...
    catat_log("🏁 Tugas harian HEM-DUM selesai.")
    catat_log("=" * 50)


if __name__ == "__main__":
    print("=" * 55)
    print("  📱 Auto Screenshot & Kirim WA (HEM-DUM)")
